...
const register = async () => {
    ...
    try {
        ...
        authMessage.value = `操作Successfully！User  Email: ${returnedEmail}。`;
...
const createItinerary = async () => {
    ...
    try {
        ...
        await axios.post('http://localhost:3000/api/itineraries', {
        ...
        createTitle.value = createDestination.value = createStartDate.value = createShortDesc.value = createDetailDesc.value = '';
